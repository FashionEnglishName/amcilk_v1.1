...
struct sched_stats {
    unsigned long long time[NUMBER_OF_STATS];  // Total time measured for all stats
    unsigned long long begin[NUMBER_OF_STATS]; // Begin time of current measurement
    unsigned long long end[NUMBER_OF_STATS];   // End time of current measurement
};
