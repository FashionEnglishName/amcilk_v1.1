...
enum ELASTIC_STATE {
    ACTIVE=1, SLEEP_REQUESTED, TO_SLEEP, SLEEPING_ADAPTING_DEQUE, SLEEPING_ACTIVE_DEQUE, SLEEPING_MUGGING_DEQUE, SLEEPING_INACTIVE_DEQUE, ACTIVATE_REQUESTED, ACTIVATING, EXIT_SWITCHING0, EXIT_SWITCHING1, EXIT_SWITCHING2, DO_MUGGING
};
