...
#define TIME_MAKE_SURE_TO_SLEEP 1000//100 //important! depends of the size of a single frame
#define TIME_MAKE_SURE_TO_ACTIVATE 1000//100 //important! depends of implementation of block/activate mechanism
#define TIME_EXIT_CTX_SWITCH 1000 //important! can not be too small for the efficiency
#define TIME_REQUEST_RECEIVE_INTERVAL 40000//25000//Bing: 50000, 45000, 75301; Finance:
...
#define KUNAL_ADAPTIVE_FEEDBACK_INEFFICIENT_THRESHOLD 0.9 //0.8~0.95
#define KUNAL_ADAPTIVE_FEEDBACK_RESPONSIVENESS_PARAMETER 1.2 //1.2~2.0
