...
#define TIME_MAKE_SURE_TO_SLEEP 10//100 //important! depends of the size of a single frame
#define TIME_MAKE_SURE_TO_ACTIVATE 10//100 //important! depends of implementation of block/activate mechanism
#define TIME_EXIT_CTX_SWITCH 10 //important! can not be too small for the efficiency
