...
#define TIME_REQUEST_RECEIVE_INTERVAL 100000//Bing: 50000, 45000, 75301; Finance:
#define TIME_CONTAINER_TRIGGER_INTERVAL (CONTAINER_COUNT/15)*2*TIME_REQUEST_RECEIVE_INTERVAL //important! when workload is high
